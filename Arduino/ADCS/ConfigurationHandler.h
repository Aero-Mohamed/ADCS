...
{
    public:
        bool init(HardwareSerial *BlueTooth_Serial, uint8_t *send_Telemetry, int16_t *set_speed, K *Speed_Control_Gains, BTS7960 *bts_7960, uint8_t *control_Speed_Flag, uint8_t *control_Angle_Flag, int16_t *set_angle);
        void monitor();
        uint16_t readInt16();
        uint8_t readInt8();
    private:
